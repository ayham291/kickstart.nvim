...
-- Move lines up and down with Alt-j/k (Alt is represented as M)
...
vim.keymap.set('n', '<leader>o', '<cmd>!opout % ' .. cwd .. '<CR>')
vim.keymap.set('n', '<leader>x', '<cmd>:w! | !compiler % ' .. cwd .. '<CR>')
...
require('lazy').setup({
  ...
  },
  {
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>gl', ':Git pull<CR>', { desc = '[G]it [L]og' })
    end,
  },
  {
    -- undotree
